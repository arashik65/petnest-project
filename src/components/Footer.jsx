      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <h1 className="text-2xl font-extrabold tracking-wide pl-10 bg-gradient-to-r from-orange-500 to-orange-400 bg-clip-text text-transparent">
              PetNest
            </h1>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <Link
                href="https://facebook.com"
                target="_blank"
                className="w-11 h-11 rounded-full bg-slate-800 flex items-center justify-center hover:bg-orange-500 transition duration-300"
              >
                <LogoFacebook className="w-5 h-5" />
              </Link>
